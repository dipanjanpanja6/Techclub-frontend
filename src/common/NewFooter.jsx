      ...
      <div className='footer-links'>
        <div className='footer-link-wrapper'>
          <div className='footer-link-items'>
            <h4>Quick Links</h4>
            <Link rel="noreferrer" target="_blank" href='http://gcect.ac.in'>Academic Calender</Link>
            <Link rel="noreferrer" target="_blank" href='http://gcect.ac.in'>Central Library</Link>
            <Link rel="noreferrer" target="_blank" href='http://gcect.ac.in'>Internal Website</Link>
          </div>
          <div className='footer-link-items'>
            <h4>Events</h4>
