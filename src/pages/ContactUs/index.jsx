...
const style = makeStyles(theme => ({
  ...
  intro: {
    ...
    color: "white",
    backgroundImage: `url(${require("../../assets/privacy.webp")})`,
  },
}))
const Index = () => {
  const sty = style()
  useEffect(() => {
    document.title = `Rules | Policies | Terms & Conditions - Tech Club - GCECT`
  }, [])
  ...
  return (
    <>
      ...
      <Grid container item xs={12} className={sty.pape}>
        <Paper elevation={10} className={sty.paper}>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Team</strong> (referred to as either &quot;the Team&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GCECT Techclub Class A
                member.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to GCECT Techclub, from <a href="https://techclub.web.app">https://techclub.web.app</a>
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            ...
            Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other
            diagnostic data.
          </p>
          ...
          <p>
            You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of
            our Service.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media
              Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You
          ...
          <p>
            ...
            means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the
