...
function EventManagement(props) {
    ...
    const past = projects ? projects.past.map(p => {
        return (
    ...
    const future = projects ? projects.future.map(p => {
        return (
        ...
        <Grid item className={sty.root}>
            {props.class =='classA' ||props.class =='classB' ?
                <Grid >
                    ...
                    {!switchAdd && <Fab color="primary" onClick={() => setSwitchAdd(true)} >
                        <AddCircleIcon />
                    </Fab>}
            ...
            <Grid item xs={12}>
                ...
                <Typography variant='body2'>
                    Previously attend events details
                </Typography>
                <Divider />
                <List>
                    {past}
