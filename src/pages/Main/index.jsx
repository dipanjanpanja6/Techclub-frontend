  ...
  return (
    <div>
      <Grid className={sty.container} container justify="center" alignContent="center">
          ...
          {state ? (
            <>
              ...
              <Grid className={sty.detx}>
                <Typography variant="h5">Welcome {state.name}</Typography>
        ...
        <Grid container justify="center" spacing={2} style={{ margin: 12 }}>
          <Grid
            item
            style={{
              // minHeight: 800,
            ...
            <div className={matches ? "" : sty.root}>
              <Tabs orientation={matches ? "horizontal" : "vertical"} variant="scrollable" value={value} onChange={handleChange} className={sty.tabs}>
