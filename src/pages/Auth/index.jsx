...
const useStyles = theme => ({
  ...
  google: { backgroundColor: "#dd4b39" },
  GitHub: { backgroundColor: "#000", color: "#fff" },
...
class Auth extends Component {
  ...
  componentWillReceiveProps = (n, c) => {
    ...
    if (n.Auth.admin.login.success === true) {
      !n.Auth.admin.login.isActivated &&
        this.setState({
          auth: true,
          ...
          <Grid item>
            {!this.state.auth && (
              <Paper elevation={5} className={classes.paper}>
                ...
                <Typography variant="subtitle1">A simple way to connect with anyone</Typography>
                <Divider />
                {this.state.signup && (
                  <form onSubmit={this.handleSignUp} className={classes.from}>
                    ...
                    />
                    <br />
                    <Button className={classes.button} variant="contained" fullWidth type="submit" color="secondary">
                      Sign up
                    </Button>
                  </form>
                )}
                ...
                <Fab onClick={this.google} size="medium" className={clsx(classes.buttonFab, classes.google)} variant="round" color="primary">
                  <SvgIcon>
                ...
                <Fab onClick={this.gitHubOuth} size="medium" className={clsx(classes.buttonFab, classes.GitHub)} variant="round" color="primary">
                  <GitHubIcon />
                </Fab>
                <Fab size="medium" onClick={this.TwitterOuth} className={clsx(classes.buttonFab, classes.twitter)} color="primary" variant="round">
                  <TwitterIcon />
                </Fab>
                <br />
                {this.state.signup && (
                  <div className={classes.help}>
                    <Typography className={classes.Link} onClick={this.handleLoginClick} variant="body2" color="primary">
                ...
                {!this.state.signup && (
                  <div className={classes.help}>
                    <Typography className={classes.Link} color="primary" onClick={this.handleLoginClick} variant="body2">
                      Register new user
                    </Typography>
                    <Typography color="error" className={classes.Link} onClick={this.forgetPass} variant="body2">
                      Forget password ?
                    </Typography>
                  </div>
                )}
