...
var myArray = ['#ff1744', '#ff6f00', '#37474f', '#ff3d00', "#dd2c00", "#33691e", "#558b2f", "#1b5e20", "#004d40", "#2e7d32", "#00695c", "#43a047", "#0091ea", "#0277bd", "#01579b", "#304ffe", "#1a237e", "#d500f9", "#651fff", "#4a148c", "#9c27b0", "#d50000", "#ff1744", "#f50057", "#e91e63", "#ffd600", "#ffea00", "#ff6f00", "#6d4c41", "#212121"]
...
function UserByUID(props) {
    ...
    return (
        ...
        <Grid>
            ...
            <DialogActions>
                <Button disabled onClick={handleClose} color="primary">Message</Button>
            </DialogActions>
       </>}
       {err && 
       <Grid container justify='center' alignItems='center' className={sty.F404} > 
          <Result
                ...
                extra={<Fab style={{marginTop:20}} size='small' variant='extended' onClick={()=>{history.push(`/`)}} color="primary">Home Back</Fab>}
            />
       </Grid>
